...
const source={uri: "https://4kwallpapers.com/images/walls/thumbs_3t/1521.jpg"}

export default class SharedElementScreen extends React.Component {
  state = {
          ...
          {state.isScene2Visible ? (
            ...
            >
              <View style={styles.scene2} ref={this.onSetScene2Ref}>
                ...
                >
                  <Image style={styles.image2} source={source} />
                </SharedElement>
              </View>
            </Animated.View>
          ) : undefined}
